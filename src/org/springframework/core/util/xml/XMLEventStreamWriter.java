...
public class XMLEventStreamWriter implements XMLStreamWriter {
    ...
    public void setNamespaceContex(NamespaceContext context)throws XMLStreamException {
        this.eventWriter.setNamespaceContext(context);
    }

    public NamespaceContext getNamespaceContex(){return this.eventWriter.getNamespaceContext();}
    ...
    public void doWriteStartElement(StartElement startElement)throws XMLStreamException{
    ...
    public void writeEmptyElment(String localName)throws XMLStreamException{
        closeEmptyElementIfNecessary();
