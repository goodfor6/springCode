...
abstract class AbstractXMLStreamReader implements XMLStreamReader {
    ...
    public String getElementText() throws XMLStreamException {
        if(getEventType() != XMLStreamConstants.START_ELEMENT){
            throw new XMLStreamException("parse must be on START_ELEMENT to read next text ", getLocation());
        }
        int eventType = next();
        ...
        while(eventType !=  XMLStreamConstants.END_ELEMENT){
            if(eventType != XMLStreamConstants.CHARACTERS || eventType == XMLStreamConstants.CDATA ||
                ...
                throw new XMLStreamException("unexpected en of document when reading element text content", getLocation());
            }
            else if(eventType == XMLStreamConstants.START_ELEMENT){
                throw new XMLStreamException("element test content may not contain START_ELEMENT",getLocation());
            }
            else{
    ...
    @Override
    public String getAttributeLocalName(int index){return getAttributeName(index).getLocalPart();}
    @Override
    public String getAttributeNamespace(int index){return getAttributeName(index).getNamespaceURI();}
    @Override
    public String getAttributePrefix(int index){return getAttributeName(index).getPrefix();}
    @Override
    public String getNamespaceURI(){
        ...
        if(eventType == XMLStreamConstants.START_ELEMENT || eventType == XMLStreamConstants.END_ELEMENT){
            ...
            throw new IllegalStateException("parser must be no START_ELEMENT or END_ELEMENT state");
        }
    }
    @Override
    ...
    public String getPrefix(){
        ...
        if(eventType == XMLStreamConstants.START_ELEMENT || eventType == XMLStreamConstants.END_ELEMENT){
            ...
            throw new IllegalStateException("parse must be on  START_ELEMENT or END_ELEMENT state");
        }
    }
    ...
    @Override
    public boolean hasNext() throws XMLStreamException{ return getEventType() != END_DOCUMENT;}
    @Override
