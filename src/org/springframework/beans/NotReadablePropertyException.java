...
public class NotReadablePropertyException extends InvalidPropertyException {
	public NotReadablePropertyException (Class<?>beanClass,String propertyName){
		super(beanClass,propertyName,"Bean property'"+propertyName+"'not readable or has an invalid getter method:"+
	                                 "Does the return type of the getter mathc the parameter type of the setter ?");
	}
